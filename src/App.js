            ...
            element={
              <>
                <section className="test-banner">
                  ...
                  <p>
                    Tato verze aplikace slouží k ověření základního principu a
                    funkčnosti nástroje. Pomocí připravených kritérií si můžete
                    vyzkoušet evaluaci webové mapové aplikace a následně
                    poskytnout zpětnou vazbu.
                  </p>
                  <p>
                    Poté prosím vyplňte krátký dotazník zpětné vazby, který Vám
                ...
                <div className="quick-feedback-link">
                  <a
                    href={feedbackUrl}
                    target="_blank"
                ...
                <section className="intro intro-full">
                  <div className="intro-text intro-text-full">
                    <h2 className="lang lang-cs">O testování</h2>
                    <br></br>
                    <h2 className="lang lang-en">About testing</h2>

                    <p className="intro-lead lang lang-cs">
                      Cílem testování je získat zpětnou vazbu k funkčnosti,
                      srozumitelnosti a praktické použitelnosti nástroje pro
                      hodnocení webových map.
                    </p>

                    <p className="intro-lead lang lang-cs">
                      V této testovací verzi je aplikace naplněna výchozím
                      datasetem vytvořeným v rámci bakalářské práce. Produkční
                      verze nástroje bude rozšířena také o základní
                      administraci, tedy možnost upravovat a přidávat vlastní
                      hodnoticí kritéria.
                    </p>
                    ...
                    <div className="testing-grid">
                      <div className="testing-card">
                        ...
                        <p>
                          Aplikace má sloužit jako nástroj pro hodnocení
                          webových mapových aplikací. Jednoduše a přehledně
                          umožňuje zhodnocení vybraného produktu, a to buď pomocí
                          pilotní sady otázek, nebo pomocí vlastních kritérií.
                          Možnost přidání vlastních kritérií bude dostupná v
                          produkční verzi.
                        </p>
                      </div>
                      ...
                      <div className="testing-card">
                        ...
                        <p>
                          Především pro tvůrce webových map, studenty a další
                          uživatele, kteří chtějí využít nástroj pro hodnocení
                          svého produktu.
                        </p>
                      </div>
                      ...
                      <div className="testing-card">
                        ...
                        <ol>
                          ...
                          <li>
                            Projděte jednotlivé kategorie a vyplňte kritéria.
                          </li>
                          <li>Zobrazte si závěrečný report.</li>
                          <li>
                            Poté prosím vyplňte krátký dotazník zpětné vazby.
                          </li>
                        </ol>
                      </div>
                      ...
                      <div className="testing-card">
                        ...
                        <p>
                          ...
                          Vyplnění nezabere více než 5 minut.
                        </p>
                    ...
                    <div className="testing-note">
                      <strong>Poznámka:</strong> Tato verze aplikace slouží pouze
                      pro testování základního principu hodnocení, fungování
                      aplikace a uživatelské přívětivosti.
                    </div>
                  </div>
                </section>
              </>
